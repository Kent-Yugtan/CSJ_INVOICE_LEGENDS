                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="text-align:right" onkeypress="return onlyNumberKey(event)" id="discount_total" class="form-control" />
>>>>>>> d0cb3e933e96400649f772b9dd9e883662f29679
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-6 px-2 w-25">
                <div class="card shadow p-2 mb-5 bg-white rounded " style="width: 100%; height:35vh">
                    ...
                    <div class="row mt-3">
                        <div class="col g-5">
                            <div class="pb-3">
                                <button type="button" class="btn btn-secondary w-100" style="color:White; background-color:#CF8029;">Save</button>
                            </div>
                            <div>
