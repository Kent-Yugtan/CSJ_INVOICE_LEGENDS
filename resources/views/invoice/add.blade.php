                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="Number" onkeypress="return onlyNumberKey(event)"
                                                id="dollar_amount" class="form-control" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="Number" onkeypress="return onlyNumberKey(event)" id="peso_rate"
                                                class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label class="formGroupExampleInput2" for="form3Example2">Converted
                                                Amount</label>
                                            <input type="Number" onkeypress="return onlyNumberKey(event)"
                                                id="converted_amount" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6 px-2 w-25">
                    <div class="card shadow p-2 mb-5 bg-white rounded " style="width: 100%; height:35vh">
                        ...
                        <div class="row mt-3">
                            <div class="col g-5">
                                <div class="pb-3">
                                    <button type="button" class="sample btn btn-secondary w-100"
...
$(document).ready(function() {
    ...
    function display_rows() {
        ...
        add_rows +=
            '<input type="number" name="quantity" id="quantity" class="form-control multi quantity" />';
        add_rows += '</div>';
        add_rows += ' </div>';
        ...
        add_rows +=
            '<input type="text" name="rate" id="rate" class="form-control multi rate" />';
        add_rows += '</div>';
        add_rows += '</div>';
    ...
    $(document).on('click', '.sample', function(e) {
        // let item_descrption = $('#item_descrption').val();
        // let quantity = $('#quantity').val();
        // let rate = $('#rate').val();
        var inputs = [];
        $("[name='invoice_items']").each(function() {
        ...
        //     var a = rate[i];
        //     alert(a.value);
        // document.getElementById("subtotal").innerHTML = rate_value;
        // $('#subtotal').val(rate_value.value);
