                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="col pt-3">
                                                                <div class="form-group">
                                                                    <label class="formGroupExampleInput">Peso Rate</label>
                                                                    <input type="text" id="peso_rate" placeholder="Peso Rate" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            <div class="row mt-4">
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <label class="formGroupExampleInput">Total Amount($)</label>
                                                                        <input type="text" id="total_amountdollar" placeholder="Total Amount" class="form-control">

                                                                    </div>
                                                                </div>
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <label class="formGroupExampleInput">Total Amount
                                                                            (PHP)</label>
                                                                        <input type="text" id="total_amountphp" placeholder="Total Amount" class="form-control">
