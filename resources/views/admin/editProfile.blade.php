                    ...
                    <form id="ProfileUpdate" method="POST" action="javascript:void(0)" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col pt-5">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="full_name" name="full_name" type="text" class="form-control @error('full_name') is-invalid @enderror " placeholder="Full Name" required>
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="col pt-3">
                                                            ...
                                                            <div class=" row mb-4">
                                                                ...
                                                                <div class="col">
                                                                    <div class="form-group">
                                                                        <label class="formGroupExampleInput2" for="form3Example2">Total Amount
                                                                            (PHP)</label>
