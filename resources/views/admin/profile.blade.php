        ...
        <form name="ProfileStore" id="ProfileStore" method="post" action="javascript:void(0)" class="row g-2 needs-validation" novalidate>
          ...
          <div class="row px-4 pb-4">
            <div class=" col pt-3 mb-3">
              ...
              <div class="form-floating mb-3">
                <input name="date_hired" type="text" onblur="(this.type='text')" onfocus="(this.type='date')" class="form-control @error('date_hired') is-invalid @enderror" id="date_hired" placeholder="Date Hired">
