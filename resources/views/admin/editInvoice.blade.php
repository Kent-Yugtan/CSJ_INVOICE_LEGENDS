        ...
        <div class="row px-3 py-1">
          <div class="col-12 w-100">
            <button type="button" id="delete_button" data-bs-toggle='modal' data-bs-target='#deleteModal'
              class="btn btn-secondary w-100" style="color: White; background-color: red;">Delete Invoice</button>
          </div>
        </div>
        ...
        <div class="row px-3 py-1">
          <div class="col-12 w-100 ">
            <button type="button" id="edit_invoice" data-bs-toggle="modal" data-bs-target="#updateModal"
              class="btn btn-secondary w-100" style="color: White; background-color: #CF8029;">Edit Invoice</button>
          </div>
...
$(document).ready(function() {
  ...
  function DeductionItems_total() {
    ...
    peso_rate = $('#edit_peso_rate').val().replaceAll(',', '') ? $('#edit_peso_rate').val().replaceAll(',', '') :
      0;
        ...
        .get(apiUrl + '/api/admin/editInvoice/' + invoice_id, {
          ...
          if (data.success) {
            ...
            if (data.data.invoice_items.length > 0) {
              ...
              $('#peso_rate').html(PHP(data.data.peso_rate).format() + " rate");
