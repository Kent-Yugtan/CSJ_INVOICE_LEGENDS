                  ...
                  <div class="col w-100">
                    <div class="input-group">
                      <button style="color:white; background-color: #CF8029;" data-bs-toggle="modal"
                        ...
                        class="btn form-check-inline pe-3 " disabled="true"><i class="fa fa-plus pe-1"></i>Add
                        Invoice</button>
                  ...
                  <div class="row">
                    <div class="col-6">
                      ...
                      <button type="button " id="submit-create-deduction" class="btn form-check-inline pe-3"
                        ...
                        style="color:white; background-color: #CF8029;width:100%" disabled="true">
                  ...
                  <div class="row mt-3">
                    ...
                    <div class="col">
                      <button type="submit" class="btn btn-secondary w-100"
                        style="color:White; background-color:#CF8029; " data-bs-dismiss="modal"
