            ...
            <div class="modal-dialog modal-lg" style="width:100%;height:100%">
                <div class=" modal-content rounded">
                    <div class="modal-body">
                        <div class="modal-title fs-5 " style="padding-left: 45px; padding-top:40px;"  id="createnvoice1"> <h3> Create Invoice </h3> </div>  
                        <div class="row whole_row">
                            <form id="invoice_items">
                                @csrf
                                <div class="row px-4 pb-4" id="header">
                                    <div class="col-md-6 px-2 w-100">
                                        <div class="card p-2 mb-5 rounded" style="border-style: none;">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div class=" form-group">
                                                                <label
                                                                    class=" formGroupExampleInput2">Description</label>
                                                                <input id="invoice_description"
                                                        ...
                                                        <div class="col"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input class="discount_type form-check-input"
                                                                    type="radio" name="discount_type" id="discount_type"
                                                                    value="percentage">
                                                                <label class="formGroupExampleInput2">
                                                                    %
                                                                </label>
                                ...
                                <div class="col-4 mb-3">
                                    <div class="form-group">
                                        ...
                                        <input type="Number" onkeypress="return onlyNumberKey(event)" id="deduction_amount" class="form-control" />
                                                ...
                                                <div class="col-12 mb-3">
                                                    <div class="row">
                                                        <div class="col-8" style="text-align:right;">
                                                            <label
                                                                style="vertical-align: -webkit-baseline-middle">Total:
                                                                <label>
                                                        </div>
                                                        <div class="col-4 mb-3"
                                                            style="justify-content:end;display:flex">
                                                ...
                                                <div class="col-12 mb-3">
                                                    <div class="row">
                                                        <div class="col-12 form-control"style="border-style: none;">
                                                            <label for="floatingTextarea"> <h7> Notes: </h7></label>
                                                            <textarea class="form-control mt-3"
                                                                placeholder="Leave a notes here" id="notes"
                                                                name="notes"></textarea>
