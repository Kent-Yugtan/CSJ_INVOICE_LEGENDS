    ...
    <div class="col-md-6 px-2">
      <div class="card shadow p-2 mb-5 bg-white rounded" style="width: 100%; height:100%">
        ...
        <div class="row px-4 pb-4">
          ...
          <div class="row">
            <div class="col mb-3">
              <button type="submit" style="width:110%; height:50px;color:white; background-color: #CF8029;" class="btn" class="btn">Save</button>
            </div>
            <div class="col mb-3">
              <button type="submit" style="width:110%; height:50px;color:white; background-color: #A4A6B3;" class="btn" class="btn">Cancel</button>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body table-responsive">
              <table style=" color: #A4A6B3;font-size: 14px;" class="table table-hover" id="datatablesSimple">
                ...
                <tbody>
                  <tr>
                    <td>Tiger Nixon</td>
                    <td><button style="width:100%; height:20px; font-size:10px; padding: 0px;" type="button" class="btn btn-danger btn-xs">Pending</button></td>
                    <td>12/31/2022</td>
                    <td>Edinburgh</td>
