  ...
  <div class="row px-4 pb-4">
    <div class="col-md-6 px-2 w-75">
          ...
          <div class="col-md-7 col-sm-12">
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <label class="text-muted " style="text-align:end"> SubTotal: </label>
              </div>
      ...
      <div class="row-md-6 w-25 px-2">
        <div class="card-responsive-md shadow p-2  bg-white rounded " <div class="row pt-3">
          ...
          .get(apiUrl + '/api/admin/editInvoice/' + invoice_id, {
            ...
            if (data.success) {
              ...
              if (data.data.invoice_items.length > 0) {
                ...
                if (data.data.discount_type === "Fixed") {
                  $('#discountType').html(" " + data.data.discount_type + " (" + discount_amount.toLocaleString(
                    'en-US', {
                      style: 'currency',
                      currency: 'USD'
                    }) + ")");
