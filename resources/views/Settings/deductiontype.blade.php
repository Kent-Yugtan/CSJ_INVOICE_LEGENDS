...
<div class="container-fluid px-4 pb-4">
    ...
    <div class="row mt-5">
        <div class="col-md-6 px-2">
            <button class="btn w-50" style="color:white; background-color: #CF8029; margin-top:5px " data-bs-toggle="modal" data-bs-target="#addModal" type="submit" id="button-addon2"> <i class="fa fa-plus pe-1"></i> Add Deduction Type </></button>
            <div class="row mt-3">
                <div class="col">
                    <div class="w-100">
                ...
                <div class="col">
                    <button type="submit" class="btn w-100" style=" color:white; background-color: #CF8029;width:30%" id="button-submit">Search</button>
                </div>
            </div>
